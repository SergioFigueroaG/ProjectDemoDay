...
class InvitedsControllerTest < ActionController::TestCase
  ...
  test "should create invited" do
    assert_difference('Invited.count') do
      post :create, invited: { correo: @invited.correo, event_id: @invited.event_id, user_id: @invited.user_id }
    end
  ...
  test "should update invited" do
    patch :update, id: @invited, invited: { correo: @invited.correo, event_id: @invited.event_id, user_id: @invited.user_id }
    assert_redirected_to invited_path(assigns(:invited))
  end
